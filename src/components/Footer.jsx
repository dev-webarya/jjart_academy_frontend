      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl relative z-10">
        ...
        <div className="border-t border-slate-800/80 pt-8 pb-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            {/* Copyright */}
            <p className="text-slate-500 text-xs sm:text-sm text-center hover:text-slate-300 transition-colors duration-200">
              © {new Date().getFullYear()} Art Academy. Made with{" "}
              <FaHeart className="inline text-pink-500 animate-pulse" /> for young artists.
            </p>
            
            {/* Additional Links */}
            <div className="flex gap-6 text-xs sm:text-sm text-slate-500">
              <Link to="/contact" className="hover:text-violet-400 transition-colors duration-200">
                Privacy Policy
              </Link>
              <Link to="/contact" className="hover:text-violet-400 transition-colors duration-200">
                Terms of Service
