        ...
        <div className="px-6 py-4">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="relative">
              <div className="w-24 h-24 rounded-2xl border-4 border-white dark:border-gray-800 shadow-xl bg-linear-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold text-2xl overflow-hidden">
                {profileImage ? (
