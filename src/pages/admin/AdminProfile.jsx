...
const AdminProfile = () => {
  ...
  const loadAdminData = () => {
    ...
    if (adminData && Object.keys(adminData).length > 0) {
      setProfileData(prevData => ({ ...prevData, ...adminData }));
      setOriginalData(prevData => ({ ...prevData, ...adminData }));
    }
  };
      ...
      <div>
          ...
          <div className="bg-linear-to-r from-purple-600 to-pink-600 p-4 text-white">
            <div className="flex flex-col md:flex-row items-center gap-4">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-white/80 text-xs mt-1"> Administrator -  </p>
              </div>
          ...
          <div className="p-4">
            ...
            <div className="mb-3">
              ...
              {isEditing ? (
                <textarea
                  ...
                  rows="3"
                  className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              ) : (
                <p className="text-gray-600 dark:text-gray-400 p-2 bg-gray-50 dark:bg-gray-700 rounded text-sm">
              ...
              <div>
                ...
                {isEditing ? (
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                ) : (
            ...
            {isEditing && (
              <div className="flex gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
                <button
                  onClick={handleSave}
                  className="flex-1 px-3 py-2 text-sm bg-linear-to-r from-purple-600 to-pink-600 text-white rounded hover:shadow-lg transition-all duration-300 font-semibold flex items-center justify-center gap-1"
                >
                  <FaSave size={14} />
                  Save
                </button>
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-2">
          <div className="bg-white dark:bg-gray-800 rounded shadow p-3 text-center">
            ...
            <h4 className="text-gray-800 dark:text-white font-semibold text-sm mt-1">Role</h4>
          ...
          <div className="bg-white dark:bg-gray-800 rounded shadow p-3 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-xs">Active</p>
          </div>
        </div>
    </div>
  );
